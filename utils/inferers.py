...
# Modification: return only first output if network prediction return several outputs (i.e. DeepSupervision)

from typing import Any, Callable, List, Sequence, Tuple, Union, Iterable
...
def sliding_window_inference(
    ...
    for slice_g in range(0, total_slices, sw_batch_size):
        ...
        if isinstance(seg_prob, Iterable):
            seg_prob = flatten(seg_prob)[0].to(device)
        else:
